...
contact_message = Text(
    ...
    "\n\n",
    "Расскажите, какую задачу должен решать бот. ",
    "Я помогу продумать сценарий, предложу техническое решение и объясню, как можно запустить проект.",
    "\n\n",
    Bold("Нажмите кнопку ниже — откроется личный чат со мной."),
)
